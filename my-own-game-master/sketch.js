...
classimg=loadImage("presentation.png")
}
...
form.display();
  ...
  if(hour==sh && minute==sm){
    text('Its ' + sh + " hour , Its a School Time ",200,140)
   
  
  }

  if(hour==hwh && minute==hwm){
    text('Its ' + hwh + " hour , Its a homework Time ",200,140)
    
  
  }

  if(hour==dh && minute==dm){
    text('Its ' + hwh + " hour , Its a dinner Time ",200,140)
    
  
  }
  if(hour==slh && minute==slm){
    text('Its ' + hwh + " hour , Its a sleep Time ",200,140)
